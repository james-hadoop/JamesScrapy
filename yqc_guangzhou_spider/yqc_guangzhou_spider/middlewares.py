...
# class YqcGuangzhouSpiderSpiderMiddleware(object):
...
#             yield r
#
#     def spider_opened(self, spider):DownloaderMiddleware
#         spider.logger.info('Spider opened: %s' % spider.name)


class YqcGuangzhouSpiderDownloaderMiddleware(object):
    url_prefix = 'http://www.gz.gov.cn'
