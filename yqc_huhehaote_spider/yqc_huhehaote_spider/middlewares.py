...
# class YqcHuhehaoteSpiderSpiderMiddleware(object):
...
class YqcHuhehaoteSpiderDownloaderMiddleware(object):
    url_prefix='http://www.changchun.gov.cn/zw_33994/'
