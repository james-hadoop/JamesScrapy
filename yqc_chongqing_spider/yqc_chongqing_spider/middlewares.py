...
class YqcChongqingSpiderSpiderMiddleware(object):
...
class YqcChongqingSpiderDownloaderMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        if str('currentPage') not in url:
            ...
            url = str(next_page.find_element_by_xpath("./a[2]").get_attribute('href'))
